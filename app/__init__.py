...
def create_app():
    ...
    from app.utils.log_capture import setup_log_capture
    ...
    from app.routes.search_v2 import bp as search_v2_bp
    from app.routes.saved import bp as saved_bp
    from app.routes.paper import bp as paper_bp
    from app.routes.home import bp as home_bp
    from app.routes.admin import bp as admin_bp

    blueprints = [auth_bp, general_bp, search_bp, search_v2_bp, saved_bp, paper_bp, home_bp, admin_bp]
